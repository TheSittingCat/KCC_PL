#The purpose of this file is to evaluate the tree generated by the parser and return the result of the evaluation. The result is a string that can be used to create a python file.
